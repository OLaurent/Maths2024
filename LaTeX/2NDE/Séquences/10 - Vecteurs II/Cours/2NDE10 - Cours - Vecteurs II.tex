...
\begin{demonstration}{}{}
  \begin{tabular}{p{12cm} p{4cm}}
    \begin{minipage}{12cm}
      ...
      Les coordonnées de $\Vecteur{MN}$ sont $(x_N-x;y_N-y)$. Or, $\Vecteur{MN}=\Vecteur{v}$, c'est-à-dire $x_N-x=x'$ et $y_N-y=y'$. On en déduit que $N$ a pour coordonnées $(x+x';y+y')$, d'où $\Vecteur{u}+\Vecteur{v}\CoordVecPl{x+x'}{y+y'}$.
    \end{minipage}
    &\begin{minipage}{4cm}
      \begin{tikzpicture}[scale=1]
