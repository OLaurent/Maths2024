...
Soient les points $A(-2; 3)$, $B(1; 1)$ et $C(4; -1)$. Montrer que les points $A$, $B$ et $C$ sont alignés.
  ...
  \vspace{3cm}
  \SimpleQRCode{https://www.youtube.com/watch?v=dZ81uKVDGpE}{1.2cm}
    ...
    \begin{enumerate}
      ...
      \begin{center}
        \begin{tikzpicture}[scale=1.5]
          ...
          \draw[thick,->,blue] (A) -- (-3,0) node[midway, below] {$-\dfrac{3}{4}\overrightarrow{AB}$};
          \draw[thick,->,blue] (-3,0) -- (-1.5, 1.5 ) node[midway, above left] {$\dfrac{1}{2}\overrightarrow{AC}$};

          \draw[thick,->,red] (B) -- (-3,0) node[midway, below] {$-\dfrac{7}{4}\overrightarrow{AB}$};
          \draw[thick,->,red] (-3,0) -- (-4.5, 4.5 ) node[midway, left] {$\dfrac{3}{2}\overrightarrow{AC}$};

          % Points H and G
          \draw[thick,->,blue] (A) -- (H) node[midway, above right] {$\overrightarrow{AH}$};
          \draw[thick,->,red] (B) -- (G) node[midway, above right] {$\overrightarrow{BG}$};
