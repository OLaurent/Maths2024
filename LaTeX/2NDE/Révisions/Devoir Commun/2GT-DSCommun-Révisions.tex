...
\begin{methode*}{Calculer les coordonnées du milieu d'un segment $\longrightarrow$ Exercices 1, 3, 4, 5, 6}{}
  \begin{tabular}{ccc}
    \begin{minipage}{8cm}
  ...
  \begin{minipage}{2.4cm}
    \vspace{2cm}
    \hfill\SimpleQRCode{https://www.youtube.com/watch?v=YTQCtSvxAmM}{1.2cm}
  \end{minipage}
  \\
  \end{tabular}
...
\begin{methode*}{Calculer la longueur d'un segment $\longrightarrow$ Exercices 1, 2, 5, 6}{}
  ...
  $$
    ...
    \begin{minipage}{2.4cm}
      ...
      \vspace{1cm}
      \hfill\SimpleQRCode{https://www.youtube.com/watch?v=pP8ebg8W9o8}{1.2cm}
    \end{minipage}
  \end{tabular}
...
\begin{center}
  ...
  \begin{methode*}{Construire un point }{}
  \end{methode*}

  \MethodeQRCodeVSmall{https://www.youtube.com/watch?v=nzABUzFM6p8}{Construire un point à partir d'une somme de vecteurs}{Exercices 3, 4 et 5}
