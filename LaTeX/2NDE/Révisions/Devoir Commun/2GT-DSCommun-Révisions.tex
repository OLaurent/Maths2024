...
\begin{center}
  ...
  \begin{methode*}[sidebyside, righthand width=2.2cm,segmentation code={}]{Construire un point à partir d'une somme de vecteurs $\longrightarrow$ Exercices 3, 4 et 5}{}
    Soit $ABC$ un triangle. Placer le point $D$ tel que $\Vecteur{AD}=2\Vecteur{AB}+\Vecteur{CB}$.

    \begin{enumerate}
      \item On trace le vecteur $2\Vecteur{AB}$ à partir du point $A$.
      \item On trace le vecteur à la suite le $\Vecteur{CB}$.
      \item On place le point $D$ tel que $\Vecteur{AD}=2\Vecteur{AB}+\Vecteur{CB}$.
    \end{enumerate}
    ...
    \begin{center}
      \begin{tikzpicture}[scale=1]
        ...
        \coordinate [label=below right:$C$] (C) at (4,-2);

        % Triangle
        \draw (A) -- (B) -- (C) -- cycle;

        % Vecteur 2AB
        \coordinate (AB2) at ($(A)!2!(B)$);
        \draw[->, thick, blue] (A) -- (AB2) node[midway, above] {$2\overrightarrow{AB}$};

        % Vecteur CB
        \coordinate (CB) at ($(C)-(B)$);
        \draw[->, thick, red] (AB2) -- ++(CB) node[midway, right] {$\overrightarrow{CB}$};

        % Point D
        \coordinate [label=below left:$D$] (D) at ($(AB2)+(CB)$);
        \draw[->, thick, green] (A) -- (D) node[midway, below right] {$\overrightarrow{AD}$};
  ...
  \MethodeQRCodeVSmall{https://www.youtube.com/watch?v=nzABUzFM6p8}{Construire un point à partir d'une somme de vecteurs}{}
  
  \MethodeQRCodeVSmall{https://www.youtube.com/watch?v=fbVrdYiY0qc}{Appliquer la relation de Chasles}{Exercices 4 et 5}
  ...
  \begin{enumerate}
    ...
    \item de même direction et de même sens que $\overrightarrow{AC}$.
    \item de même direction que $\overrightarrow{BC}$ mais de sens contraire.
  \end{enumerate}
  \begin{center}
...
\begin{center}
  ...
  \MethodeQRCodeVSmall{https://www.youtube.com/watch?v=UVXFEDUnSjI}{Calculer une évolution}{Exercices 1, 3, 4, 7 et 8 }
  
  \MethodeQRCodeVSmall{https://www.youtube.com/watch?v=qOg2eXd8Hv0}{Calculer des taux d'évolutions successifs}{Exercices 3,7 et 8}
  
  \MethodeQRCodeVSmall{https://youtu.be/NiCxHYkpNiM}{Calculer un taux d'évolution réciproque}{Exercices 4, 7 et 8}
  
  \medskip
  \settcbcounter{exerciceinterro}{0}
...
\begin{center}
  ...
  \MethodeQRCodeVSmall{https://youtu.be/nwdv78G1kII}{Résoudre graphiquement une équation ou une inéquation}{Exercices 1, 3}
  
  \MethodeQRCodeVSmall{https://www.youtube.com/watch?v=zZ9SbX8mC2o}{Dresser un tableau de signe}{Exercices 2, 3 et 4}
  
  \MethodeQRCodeVSmall{https://www.youtube.com/watch?v=qoNLr9NkvUE}{Résoudre une inéquation produit}{Exercices 2, 3 et 4}
...
\begin{center}
  ...
  \begin{exerciceinterro}{}{}
    ...
    \begin{enumerate}
      \item $\overrightarrow{r}$ a une norme est égale à $\lVert \overrightarrow{CD} \rVert$.
      \item $\overrightarrow{m}$ a la même direction et le même sens que $\overrightarrow{AC}$.
      \item $\overrightarrow{t}$ a la même direction que $\overrightarrow{BC}$ mais pas le même sens.
    \end{enumerate}
    \end{exerciceinterro}
